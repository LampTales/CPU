...
#
# Generated by Vivado on Mon Apr 24 15:15:15 +0800 2023
...
# Script info
echo -e "clk_ip.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_ip xil_defaultlib.clk_ip xil_defaultlib.glbl -log elaborate.log
}
