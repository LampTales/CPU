...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/Users/Wiman/VivadoSaving/CPU/CPU.runs/clk_ip_synth_1 -new_name clk_ip -ip [get_ips clk_ip]]
